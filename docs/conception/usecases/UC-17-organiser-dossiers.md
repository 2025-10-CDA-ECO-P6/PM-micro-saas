...
- **PNJ** — avec template "Fiche PNJ générique"
- **Personnages joueurs** — avec template "Fiche personnage générique"
- **Scénarios** — sans template par défaut (structure via UC-02)
- **Notes** — sans template par défaut

Ces dossiers sont non supprimables mais renommables.
