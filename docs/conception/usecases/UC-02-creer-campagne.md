...
- L'espace est archivé automatiquement 48h après la fin de la session si le MJ ne l'ouvre pas.
...
- L'archivage automatique est programmé.
...
- Un espace one-shot est archivé automatiquement après 48h d'inactivité post-session.
  Le MJ peut désactiver l'archivage automatique ou rouvrir un espace archivé.
...
- Un one-shot est archivé automatiquement 48h après la session si le MJ ne le rouvre pas.
