...
| zone de documents partagés | Zone principale de la vue joueur post-accès listant les documents PUBLIC visibles selon le périmètre d'accès (SESSION ou SPACE). Source : UC-12 scénario nominal §4 ; RB-12-01 ; AR-06. |
