...
> Déclinaison PERSONAL de la surface Préparation — pas un écran-UC autonome (mix assumé, zoning §S9 RÉSOLU).
> Fiche de description d'écran basse-fidélité — espace personnel.
...
état vide (espace personnel fraîchement créé) :
  ...
  (AR-16 — aucun dossier système nommé ; AR-20 — réceptacle garanti) ; ce dossier
  reste visible même vide tant qu'il est le seul dossier de l'espace (exception
  PERSONAL — AR-16 Précision 2026-07-15) — il constitue le seul repère de navigation
  à cette étape ; la zone de contenu invite à créer un premier document ; l'accès
  à l'éditeur est disponible immédiatement pour une capture sans friction (AR-15)
...
état chargé (espace personnel avec documents) :
  ...
  (réceptacle garanti, toujours présent) ; dès qu'un autre dossier existe,
