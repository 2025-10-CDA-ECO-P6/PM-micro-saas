...
> Ces valeurs sont **volatiles** : consolidées et datées dans `docs/cahier-des-charges.md` §12.4 (arrêtées au 2026-07-02). La présente section §3 reste la **source de vérité** ; toute révision se répercute d'abord ici, puis sur la table §12.4.
