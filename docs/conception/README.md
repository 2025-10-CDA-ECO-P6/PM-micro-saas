...
Chaque contributeur applique ce balayage au fichier qu'il vient de modifier, **avant toute intégration**, pour vérifier qu'il n'a pas introduit l'un des deux motifs. Pas d'outillage imposé — la détection est manuelle et rapide (lecture guidée par les motifs).
