# Haversack — Présentation & Identité

Dossier dédié aux assets de présentation et d'identité visuelle du produit.
...
- **User journey — Vue session** : [`docs/conception/user-journeys/UJ-UC-06-vue-session.md`](../user-journeys/UJ-UC-06-vue-session.md) — base de dérivation des wireframes
- **Use cases** : [`docs/conception/usecases/`](../usecases/) (UC-02 création campagne, UC-06 vue session)
- **Personas** : [`docs/conception/persona/`](../persona/) — comprendre les profils utilisateurs
- **Vision produit** : [`docs/conception/vision/vision-produit.md`](../vision/vision-produit.md)
