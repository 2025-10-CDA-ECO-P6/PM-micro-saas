...
>
> Distinct de `docs/presentation/wireframes/AUDIT.md`, qui audite la
> **conformité des planches** (zones, états, RB/AR couverts) — ce
> document-ci audite l'**état de navigabilité du parcours** matérialisé
> par le prototype.
