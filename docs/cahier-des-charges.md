...
| Nombre de joueurs par session (palier gratuit) | 4 joueurs distincts, MJ non compté — sémantique résolue : comptage à l'octroi, agnostique au type d'accès (RB-09-21 fait foi) | `docs/conception/vision/vision-produit.md §3`, `docs/conception/domain/space-management.md` (invariant 11), `docs/conception/usecases/UC-09` (RB-09-21) |
