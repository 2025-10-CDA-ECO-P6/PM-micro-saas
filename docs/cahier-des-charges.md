...
> Sources : docs/conception/vision/vision-produit.md
...
| Could Have | Valeur réelle mais non prioritaire pour la validation initiale ; peut être livré dans une vague ultérieure sans compromettre l'adoption. | Types de document personnalisés, réimport de fichier de sauvegarde (post-MVP, distinct de l'export), persistance inter-sessions des notes du joueur |
...
Valeur réelle identifiée mais non prioritaire pour la validation initiale ; envisageable dans une vague ultérieure sans compromettre l'adoption.
...
> Sources : docs/conception/vision/moscow.md, docs/conception/vision/vision-produit.md
...
> Sources : docs/conception/vision/vision-produit.md, docs/conception/persona/README.md, docs/conception/parcours/README.md
...
> Sources : docs/conception/usecases/UC-01-mode-local-sans-compte.md à UC-14-recherche.md, docs/conception/usecases/README.md, docs/conception/user-stories/US-UC-01-mode-local-sans-compte.md à US-UC-14-recherche.md
...
> Sources : docs/conception/nfr/README.md, docs/conception/nfr/NFR-PERF-01 à NFR-PERF-04, NFR-OFF-01 à NFR-OFF-04, NFR-CONF-01 à NFR-CONF-04, NFR-ACC-01 à NFR-ACC-04, NFR-I18N-01 à NFR-I18N-03 (19 fiches)
...
3. La sémantique exacte des statuts d'un espace personnel — archivé ou gelé — un espace personnel étant mono-membre, à la différence d'un espace partagé pour lequel ces statuts ont été pensés.
4. La liste des fournisseurs d'identité externes retenus pour l'inscription et la connexion — décision de nature produit et technique, non arrêtée à ce stade.
...
**Sémantique de comptage du quota du palier gratuit** : l'invariant limitant l'accès à une session à 4 joueurs distincts pour un espace dont le propriétaire est au palier gratuit (`docs/conception/domain/space-management.md`, invariant 11) est explicitement marqué « à préciser à la modélisation » — la sémantique exacte de comptage n'est pas fixée : un membre compte-t-il une fois par espace ou par session, et cette règle s'étend-elle aux types d'accès futurs ? Ce point reste non tranché.
...
**Rapport d'audit référencé mais absent** : l'index `docs/audit/README.md` référence un rapport intitulé « audit-conception-pure-2026-06 », présenté comme portant « 9 points à trancher ». Ce fichier n'est pas présent dans le dépôt au moment de la rédaction de ce cahier des charges. Les 9 points annoncés ne peuvent donc pas être consolidés dans la présente annexe en l'état ; le rapport est à restaurer ou à fournir si sa prise en compte est attendue avant la construction du MVP.
...
|---|---|
| 1. Présentation & contexte | `docs/conception/vision/vision-produit.md` |
| 2. Objectifs, enjeux & hypothèses | `docs/conception/vision/vision-produit.md` |
| 3. Périmètre (MoSCoW) | `docs/conception/vision/moscow.md`, `docs/conception/vision/vision-produit.md` |
| 4. Acteurs & besoins | `docs/conception/vision/vision-produit.md`, `docs/conception/persona/README.md`, `docs/conception/parcours/README.md` |
