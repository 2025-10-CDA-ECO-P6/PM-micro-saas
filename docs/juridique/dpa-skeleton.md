...
**Renvoi conception** : ADR-013 §2 (procédure d'exercice des droits des invités, périmètre distinct) ; Lot 14 du backlog (« définir l'adresse email support + la procédure d'exercice des droits des invités » — item non encore réalisé).
