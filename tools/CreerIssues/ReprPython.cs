...
/// <summary>
/// Reproduit <c>repr()</c> de Python sur une chaîne et sur une liste de
/// chaînes, tel qu'interpolé par une f-string Python (<c>f"{une_liste}"</c>
/// applique <c>repr</c> à la liste, qui applique lui-même <c>repr</c> à
/// chaque élément). Forme miroir de <c>VerifMailleAgregat.ReprPython</c>,
/// dupliquée plutôt que partagée. C'est ce rendu, et non une sérialisation
/// JSON ni un <c>ToString()</c> de collection .NET, que porte chaque ligne de
/// la sortie de référence citant une liste de libellés (jalon, nature de
/// tranche, nature) ou un message d'erreur reprenant une valeur de champ.
/// </summary>
