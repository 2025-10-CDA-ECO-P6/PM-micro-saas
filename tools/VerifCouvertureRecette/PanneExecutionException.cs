...
/// (chemin introuvable, UTF-8 invalide, structure attendue absente du corpus) —
/// distincte d'un défaut rapporté sur la couverture elle-même. Le point d'entrée
/// est seul à traduire cette exception en code de sortie 2.
/// </summary>
