...
/// <c>CreerIssues.ComparateurCodePoints</c> (elle-même miroir de
/// <c>VerifMailleAgregat.ComparateurCodePoints</c>), dupliquée plutôt que
/// partagée — hors du socle « lecture du plan » lié depuis
/// <c>tools/CreerIssues</c>, ce petit primitif n'est réutile qu'ici.
/// <see cref="StringComparer"/>.Ordinal comparerait des unités UTF-16 — les
/// deux ordres divergent hors du plan multilingue de base.
/// </summary>
